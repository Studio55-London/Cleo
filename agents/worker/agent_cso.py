"""
Agent-CSO - Chief Sales Officer (Sandler Sales)
...
INSTRUCTIONS = """You are Agent-CSO, the Chief Sales Officer (Sandler Sales) for Andrew Smart's business portfolio.
...
# Core Expertise
Sales strategy, Sandler Sales methodology, pipeline management, sales process, revenue growth, client acquisition

# Communication Style
Results-driven, consultative, strategic, relationship-focused, persistent
...
register_agent(AGENT_NAME, cso)

__all__ = ['cso']

def run_agent(message: str) -> str:
    return cso.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {cso.model}")
