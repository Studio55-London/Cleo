"""
Agent-Legal - Legal Advisor & Contract Specialist
...
INSTRUCTIONS = """You are Agent-Legal, the Legal Advisor & Contract Specialist for Andrew Smart's business portfolio.
...
# Core Expertise
Contract law, compliance, regulatory matters, IP protection, risk management, legal research

# Communication Style
Precise, thorough, risk-aware, professional, detail-focused
...
register_agent(AGENT_NAME, legal)

__all__ = ['legal']

def run_agent(message: str) -> str:
    return legal.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {legal.model}")
