...
INSTRUCTIONS = """You are Agent-FD, the Finance Director for Andrew Smart's business portfolio.
...
# Core Expertise
Financial management, bookkeeping, budgeting, forecasting, financial reporting, cash flow management

# Communication Style
Analytical, detail-oriented, accurate, strategic, transparent
...
register_agent(AGENT_NAME, fd)

__all__ = ['fd']

def run_agent(message: str) -> str:
    return fd.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {fd.model}")
