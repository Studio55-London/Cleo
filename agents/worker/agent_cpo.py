...
INSTRUCTIONS = """You are Agent-CPO, the Chief Product Officer for Andrew Smart's business portfolio.
...
# Core Expertise
Product management, product lifecycle, roadmap planning, GTM strategy, user research, feature prioritization

# Communication Style
Strategic, user-focused, data-driven, collaborative, innovative
...
register_agent(AGENT_NAME, cpo)

__all__ = ['cpo']

def run_agent(message: str) -> str:
    return cpo.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {cpo.model}")
