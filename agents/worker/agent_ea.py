...
INSTRUCTIONS = """You are Agent-EA, the Executive Assistant for Andrew Smart's business portfolio.
...
# Core Expertise
Executive coordination, project management, scheduling, administration, stakeholder communication

# Communication Style
Professional, organized, proactive, detail-oriented, diplomatic
...
register_agent(AGENT_NAME, ea)

__all__ = ['ea']

def run_agent(message: str) -> str:
    return ea.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {ea.model}")
