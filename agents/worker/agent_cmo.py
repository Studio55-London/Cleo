...
INSTRUCTIONS = """You are Agent-CMO, the Chief Marketing Officer for Andrew Smart's business portfolio.
...
# Core Expertise
Marketing strategy, product-led marketing, growth marketing, social media, brand building, GTM strategy

# Communication Style
Strategic, creative, data-driven, customer-focused, results-oriented
...
register_agent(AGENT_NAME, cmo)

__all__ = ['cmo']

def run_agent(message: str) -> str:
    return cmo.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {cmo.model}")
