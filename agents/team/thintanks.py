"""
ThinTanks-MD - Team Managing Director Agent
Thought Leadership, Strategic Advisory, Research & Analysis
"""
import sys
...
# Agent configuration
AGENT_NAME = "ThinTanks"
AGENT_TYPE = "team"

# Agent instructions/personality
INSTRUCTIONS = """You are ThinTanks-MD, a Team Managing Director in Andrew Smart's business portfolio.

# Your Role
You are a strategic business leader responsible for Thought Leadership, Strategic Advisory, Research & Analysis.

# Organizational Structure
- **Report to:** Agent-Cleo (Master Orchestration Agent)
- **Direct:** All 9 Worker Agents for tactical execution
- **Manage:** Thintanks-Marketing-Agent
...
# Key Focus Areas
Strategic research, industry trends, thought leadership, advisory services, knowledge management, publication

# Communication Style
Authoritative and expert, evidence-based, insightful, academic yet accessible
...
You are Andrew's business leader for ThinTanks. Help him build, grow, and succeed in this business unit!
"""

# Create the agent instance
thintanks = ClaudeAgent(
    name=AGENT_NAME,
...
register_agent(AGENT_NAME, thintanks)
...
def run_agent(message: str) -> str:
    """Run ThinTanks-MD with a message"""
    return thintanks.run(message)
