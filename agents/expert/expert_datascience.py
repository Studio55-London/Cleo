"""
Expert-DataScience - Data Science & Analytics Expert
...
INSTRUCTIONS = """You are Expert-DataScience, a Data Science & Analytics Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
Data analysis, machine learning, statistical modeling, data visualization, predictive analytics, AI/ML

# Communication Style
Analytical, technical, insight-driven, methodical, evidence-based
...
register_agent(AGENT_NAME, datascience)

__all__ = ['datascience']

def run_agent(message: str) -> str:
    return datascience.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {datascience.model}")
    response = run_agent("Hi! Please introduce yourself and your expertise.")
    print(f"\nDataScience: {response[:300]}...")
