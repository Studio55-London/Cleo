"""
Expert-FinancialModeling - Financial Modeling & Valuation Expert
...
AGENT_NAME = "FinancialModeling"
AGENT_TYPE = "expert"

INSTRUCTIONS = """You are Expert-FinancialModeling, a Financial Modeling & Valuation Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
Financial modeling, valuation analysis, DCF models, scenario planning, investment analysis, forecasting

# Communication Style
Analytical, precise, detail-oriented, strategic, data-driven
...
register_agent(AGENT_NAME, financialmodeling)

__all__ = ['financialmodeling']

def run_agent(message: str) -> str:
    return financialmodeling.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {financialmodeling.model}")
    response = run_agent("Hi! Please introduce yourself and your expertise.")
    print(f"\nFinancialModeling: {response[:300]}...")
