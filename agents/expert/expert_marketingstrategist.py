"""
Expert-MarketingStrategist - Marketing Strategy Expert
...
INSTRUCTIONS = """You are Expert-MarketingStrategist, a Marketing Strategy Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
Marketing strategy, positioning, competitive analysis, market research, GTM strategy, brand strategy

# Communication Style
Strategic, creative, analytical, market-focused, innovative
...
marketingstrategist = ClaudeAgent(
    name=AGENT_NAME,
...
register_agent(AGENT_NAME, marketingstrategist)

__all__ = ['marketingstrategist']

def run_agent(message: str) -> str:
    return marketingstrategist.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {marketingstrategist.model}")
    response = run_agent("Hi! Please introduce yourself and your expertise.")
    print(f"\nMarketingStrategist: {response[:300]}...")
