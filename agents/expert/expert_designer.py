"""
Expert-Designer - Design & UX Expert
...
INSTRUCTIONS = """You are Expert-Designer, a Design & UX Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
UX/UI design, visual design, design thinking, user research, prototyping, design systems

# Communication Style
Creative, user-focused, aesthetic, innovative, empathetic
...
register_agent(AGENT_NAME, designer)

__all__ = ['designer']

def run_agent(message: str) -> str:
    return designer.run(message)
