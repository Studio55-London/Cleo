"""
Expert-Copywriter - Copywriting Expert
...
INSTRUCTIONS = """You are Expert-Copywriter, a Copywriting Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
Persuasive writing, sales copy, brand voice, messaging, conversion optimization, storytelling

# Communication Style
Persuasive, creative, compelling, audience-focused, engaging
...
register_agent(AGENT_NAME, copywriter)

__all__ = ['copywriter']

def run_agent(message: str) -> str:
    return copywriter.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {copywriter.model}")
    response = run_agent("Hi! Please introduce yourself and your expertise.")
    print(f"\nCopywriter: {response[:300]}...")
