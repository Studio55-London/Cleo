"""
Expert-ESG - Environmental, Social & Governance Expert
...
INSTRUCTIONS = """You are Expert-ESG, a Environmental, Social & Governance Expert providing specialized expertise to Andrew Smart's business portfolio.
...
# Deep Expertise
ESG reporting, sustainability strategy, corporate governance, stakeholder engagement, impact measurement

# Communication Style
Strategic, values-driven, comprehensive, stakeholder-focused, forward-thinking
...
register_agent(AGENT_NAME, esg)

__all__ = ['esg']

def run_agent(message: str) -> str:
    return esg.run(message)

if __name__ == "__main__":
    print(f"[SUCCESS] {AGENT_NAME} initialized")
    print(f"Type: {AGENT_TYPE}")
    print(f"Model: {esg.model}")
